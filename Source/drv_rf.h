...
static uint8_t SYNC_SET[SYNC_SIZE] = { 0x01, 0xB4, 0x2B, 0x00, 0x00 }; // 2gfsk
//static uint8_t SYNC_SET[SYNC_SIZE] = { 0x09, 0xB4, 0x2B, 0x00, 0x00 }; // 4gfsk
...
static uint8_t pkt_config1[1] = {0x00}; // 2gfsk
//static uint8_t pkt_config1[1] = {0x20}; // 4gfsk
static uint8_t pkt_field_1_config[1] = {0x00}; // 2gfsk
//static uint8_t pkt_field_1_config[1] = {0x10}; // 4gfsk
...
static uint8_t MODEM_SET_1A[MODEM_SIZE_1A] = { 0x03, 0x00, 0x07, 0x02, 0xee, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x05, }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1A[MODEM_SIZE_1A] = { 0x05, 0x00, 0x07, 0x02, 0xee, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x10, }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1A[MODEM_SIZE_1A] = { 0x03, 0x00, 0x07, 0x11, 0x94, 0x00, 0x09, 0xC9, 0xC3, 0x80, 0x00, 0x07, }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_1B[MODEM_SIZE_1B] = { 0x76, 0x00, 0x00, 0x67, 0x60, 0x4d, 0x36, 0x21, 0x11, 0x08, 0x03, 0x01 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1B[MODEM_SIZE_1B] = { 0x62, 0x00, 0x00, 0x67, 0x60, 0x4d, 0x36, 0x21, 0x11, 0x08, 0x03, 0x01 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1B[MODEM_SIZE_1B] = { 0xDD, 0x00, 0x00, 0x67, 0x60, 0x4d, 0x36, 0x21, 0x11, 0x08, 0x03, 0x01 }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_1C[MODEM_SIZE_1C] = { 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0x20, 0x10 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1C[MODEM_SIZE_1C] = { 0x05, 0x00, 0x08, 0x03, 0x80, 0x00, 0x10, 0x10 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_1C[MODEM_SIZE_1C] = { 0x01, 0x00, 0x08, 0x03, 0x80, 0x00, 0x20, 0x20 }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_2A[MODEM_SIZE_2A] = { 0x02, 0x09, 0x00, 0xFB, 0xA9, 0x00, 0x7E, 0x02, 0xC2, 0x00, 0x04, 0x36 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_2A[MODEM_SIZE_2A] = { 0x04, 0x12, 0x00, 0x7D, 0xD4, 0x00, 0x04, 0x02, 0x02, 0x00, 0x00, 0x12 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_2A[MODEM_SIZE_2A] = { 0x00, 0x41, 0x07, 0xDD, 0x44, 0x07, 0xE0, 0x02, 0x00, 0x00, 0x00, 0x12 }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_2B[MODEM_SIZE_2B] = { 0xC0, 0x0E, 0x1E, 0xAA, 0xC0, 0x00, 0x00, 0xE2 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_2B[MODEM_SIZE_2B] = { 0xC0, 0x2A, 0x12, 0x3C, 0xE0, 0x00, 0x00, 0xE2 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_2B[MODEM_SIZE_2B] = { 0xC1, 0xF7, 0x01, 0xBD, 0xE0, 0x00, 0x00, 0xE2 }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_3A[MODEM_SIZE_3A] = { 0x11, 0x72, 0x72, 0x00, 0x1A, 0xFF, 0xFF, 0x00, 0x2B, 0x0c, 0xA4, 0x02 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_3A[MODEM_SIZE_3A] = { 0x11, 0xE4, 0xE4, 0x00, 0x1A, 0xFF, 0xFF, 0x00, 0x2B, 0x0c, 0xA4, 0x03 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_3A[MODEM_SIZE_3A] = { 0x11, 0x0E, 0x0E, 0x00, 0x1A, 0x40, 0x00, 0x00, 0x28, 0x0c, 0xA4, 0x03 }; // unknown old 2gfsk 56k
...
static uint8_t MODEM_SET_3B[MODEM_SIZE_3B] = { 0xD6, 0x83, 0x01, 0x33, 0x01, 0x80, 0xFF, 0x0c, 0x00, 0x00, 0x40 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_3B[MODEM_SIZE_3B] = { 0xD6, 0x03, 0x01, 0x85, 0x01, 0xF0, 0xFF, 0x0c, 0x00, 0x00, 0x40 }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_SET_3B[MODEM_SIZE_3B] = { 0xD6, 0x03, 0x01, 0x26, 0x01, 0x80, 0x40, 0x0c, 0x00, 0x00, 0x40 }; // unknown old 2gfsk 56k
...
//static uint8_t MODEM_CHFLT_RX1_CHFLT_A[MODEM_CHFLT_RX1_CHFLT_A_SIZE] = { 0xff, 0xc4, 0x30, 0x7f, 0xf5, 0xb5, 0xb8, 0xde, 0x05, 0x17, 0x16, 0x0c }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_CHFLT_RX1_CHFLT_B[MODEM_CHFLT_RX1_CHFLT_B_SIZE] = { 0x03, 0x00, 0x15, 0xff, 0x00, 0x0f }; // 4gfsk, 4800ksps, 20kHz dev
static uint8_t MODEM_CHFLT_RX1_CHFLT_A[MODEM_CHFLT_RX1_CHFLT_A_SIZE] = { 0xff, 0xba, 0x0f, 0x51, 0xcf, 0xa9, 0xc9, 0xfc, 0x1b, 0x1e, 0x0f, 0x01 }; // 2gfsk, 4800ksps, 20kHz dev
static uint8_t MODEM_CHFLT_RX1_CHFLT_B[MODEM_CHFLT_RX1_CHFLT_B_SIZE] = { 0xfc, 0xfd, 0x15, 0xff, 0x00, 0x0f }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_CHFLT_RX1_CHFLT_A[MODEM_CHFLT_RX1_CHFLT_A_SIZE] = { 0xff, 0xba, 0x0f, 0x51, 0xcf, 0xa9, 0xc9, 0xfc, 0x1b, 0x1e, 0x0f, 0x01 }; // unknown old 2gfsk 56k
//static uint8_t MODEM_CHFLT_RX1_CHFLT_B[MODEM_CHFLT_RX1_CHFLT_B_SIZE] = { 0xfc, 0xfd, 0x15, 0xff, 0x00, 0x0f }; // unknown old 2gfsk 56k

//static uint8_t MODEM_CHFLT_RX2_CHFLT_A[MODEM_CHFLT_RX2_CHFLT_A_SIZE] = { 0xff, 0xc4, 0x30, 0x7f, 0xf5, 0xb5, 0xb8, 0xde, 0x05, 0x17, 0x16, 0x0c }; // 4gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_CHFLT_RX2_CHFLT_B[MODEM_CHFLT_RX2_CHFLT_B_SIZE] = { 0x03, 0x00, 0x15, 0xff, 0x00, 0x0f }; // 4gfsk, 4800ksps, 20kHz dev
static uint8_t MODEM_CHFLT_RX2_CHFLT_A[MODEM_CHFLT_RX2_CHFLT_A_SIZE] = { 0x7e, 0x64, 0x1b, 0xba, 0x58, 0x0b, 0xdd, 0xce, 0xd6, 0xe6, 0xf6, 0x00 }; // 2gfsk, 4800ksps, 20kHz dev
static uint8_t MODEM_CHFLT_RX2_CHFLT_B[MODEM_CHFLT_RX2_CHFLT_B_SIZE] = { 0x03, 0x03, 0x15, 0xf0, 0x3f, 0x00 }; // 2gfsk, 4800ksps, 20kHz dev
//static uint8_t MODEM_CHFLT_RX2_CHFLT_A[MODEM_CHFLT_RX2_CHFLT_A_SIZE] = { 0xff, 0xba, 0x0f, 0x51, 0xcf, 0xa9, 0xc9, 0xfc, 0x1b, 0x1e, 0x0f, 0x01 }; // unknown old 2gfsk 56k
//static uint8_t MODEM_CHFLT_RX2_CHFLT_B[MODEM_CHFLT_RX2_CHFLT_B_SIZE] = { 0xfc, 0xfd, 0x15, 0xff, 0x00, 0x0f }; // unknown old 2gfsk 56k
...
static uint8_t PA_SET[PA_SIZE] = { 0x08, 0x7F, 0x00, 0x5D, 0x00, 0x23 };
